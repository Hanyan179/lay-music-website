package com.fateechoes.service;
...
public interface EventService {
     ...
     * @return 事件列表
     */
    List<EventDTO> getEventsByBookCode(Long bookCode);
     ...
     */
    Map<String, PersonalEventVO> buildPersonalEventsMap(Long bookCode);
     ...
     * @return 起始事件ID
     */
    String getStartingEventId(Long bookCode);
}
